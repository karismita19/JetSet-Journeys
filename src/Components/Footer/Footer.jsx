                ...
                <div className="footerCard flex">
                    <div className="footerIntro flex">
                        <div data-aos="fade-up" className="logoDiv">
                            <h1>JetSet Journeys</h1>
                        </div>

                        <div data-aos="fade-up" className="footerParagraph">
                        With a passion for exploration, JetSet Journeys curates unforgettable travel experiences tailored to every adventurer’s dream.
                        </div>
                    ...
                    <div className="footerDiv flex">
                        <small>Copyright © 2024 JetSet Journeys | All Rights Reserved.</small>
                        <small>Website Developed by Karismita</small>
                    </div>
